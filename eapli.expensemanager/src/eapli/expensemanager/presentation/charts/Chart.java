 ...
 * @author nuno
 */
public class Chart extends ApplicationFrame implements IChart {
    ...
    public Chart(String windowTitle) {
        super(windowTitle);
    ...
    public void setDataset(Map<ExpenseType, BigDecimal> mapExpenses) {
        ...
        for (Map.Entry<ExpenseType, BigDecimal> entry : mapExpenses.entrySet()) {
            //System.out.println("Expenses for type:" + entry.getKey().getDescription());
            dataset.addValue(entry.getValue(), series1, entry.getKey().getDescription());
        }
